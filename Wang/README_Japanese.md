...
- CUDA対応 NVIDIA GPU（推奨）
- VRAM: 8GB以上（大規模実験では16GB以上）
- 動作確認環境: PyTorch 2.0+, CUDA 11.8/12.1

---

## Roadmap

- [ ] 統一されたコードベース（共通コードブロックの標準化）
- [ ] YAML設定ファイルサポート
- [ ] CLIインターフェースの統一
- [ ] 追加の分析ツール
...
- Kabashima, Y., et al. "Phase transitions and computational complexity in matrix factorization"
- Rangan, S., & Fletcher, A. K. "Iterative estimation of constrained rank-one matrices in noise"
- Lesieur, T., et al. "Statistical and computational phase transitions in spiked tensor estimation"
