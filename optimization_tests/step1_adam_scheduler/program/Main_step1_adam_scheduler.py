# ============================================================
# Teacher–Student Masked MF - STEP 2: Adam + Learning Rate Scheduling
# Perfect Bi-Regular Graph (no duplicate edges)
#
# STEP 2 MODIFICATION:
# - Add Cosine Annealing Learning Rate Scheduling to Adam optimizer
# - Gradually decay learning rate from initial value to eta_min
# - Maintain alternating update strategy (W then X)
#
# STEP 1: Manual Adam Optimizer (completed)
# STEP 2: Learning Rate Scheduling (current)
#
...
if __name__ == "__main__":
    print("\n" + "=" * 100)
    print("STEP 1: ADAM OPTIMIZER - Multi-Alpha Training")
    print("=" * 100)
    ...
    import json
    json_path = RESULT_DIR / f'results_step2_epoch{EPOCHS_PER_ALPHA}.json'
