#!/usr/bin/env python
"""
Dense-mask G-AMP core module with F=1, exact Onsager correction,
...
the Dence_cosine formulation while initializing both student matrices from
teacher-correlated Gaussian noise:
...
def initialize_informative_student_messages(
    ...
    stay on the same scale as the random initialization baseline.
    """
...
def train_single_replica(
    ...
    """
    Train a single replica using G-AMP with F=1, exact Onsager correction,
    and informative student initialization.
    """
