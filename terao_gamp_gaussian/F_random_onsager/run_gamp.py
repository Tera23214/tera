#!/usr/bin/env python
"""
G-AMP Simulation Runner with Random F and Onsager Correction.

Runs G-AMP algorithm with F ~ N(0,1) and proper Onsager term for various alpha values.
"""
...
from terao_gamp_gaussian.F_random_onsager.core import train_single_replica
...
if __name__ == "__main__":
    print("=" * 60)
    print("G-AMP with Random F ~ N(0,1) + Onsager Correction")
    ...
    results_dir_name = f"{timestamp}_gamp_F_random_onsager_{N1}x{M}_alpha{ALPHA_START}-{ALPHA_STOP}"
    ...
    # Save configuration
    config = {
        'algorithm': 'gamp_F_random_onsager',
        'N1': N1,
        'N2': N2,
        'M': M,
