#!/usr/bin/env python
"""
Parallel order-parameter-vs-step runner for sequentially aggregated F=1 Edge_Alternating.
"""
...
def save_config(results_dir: Path, args: argparse.Namespace, devices: list[str]) -> None:
    config = {
        "algorithm": "gamp_Edge_Alternating_F_1_order_parameters_vs_step_sequential",
...
def main() -> int:
    ...
    print("=" * 72)
    print("Sequential F=1 Edge_Alternating Order Parameters vs Step")
    print("=" * 72)
    ...
    results_dir = results_root / (
        f"{timestamp}_order_parameters_vs_step_Edge_Alternating_F_1_sequential_"
