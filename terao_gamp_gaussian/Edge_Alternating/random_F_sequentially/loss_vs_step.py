#!/usr/bin/env python
"""
Parallel loss-vs-step runner for sequentially aggregated random-F Edge_Alternating.
"""
...
def save_config(results_dir: Path, args: argparse.Namespace, devices: list[str]) -> None:
    config = {
        "algorithm": "gamp_Edge_Alternating_random_F_loss_vs_step_sequential",
...
def main() -> int:
    ...
    print("=" * 72)
    print("Sequential Random-F Edge_Alternating Loss vs Step")
    print("=" * 72)
    ...
    results_dir = results_root / (
        f"{timestamp}_loss_vs_step_Edge_Alternating_random_F_sequential_"
