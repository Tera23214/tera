#!/usr/bin/env python
"""
Parallel runner for the random-graph version of Edge_Alternating G-AMP.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the random-graph version of Edge_Alternating G-AMP in parallel, "
...
def save_config(
    ...
    config = {
        "algorithm": "gamp_Edge_Alternating_random_graph_parallel",
...
def main() -> int:
    ...
    results_dir = results_root / (
        f"{timestamp}_gamp_Edge_Alternating_random_graph_parallel_"
    ...
    print("=" * 72)
    print("Parallel Edge_Alternating G-AMP - Random Graph Version")
    print("=" * 72)
