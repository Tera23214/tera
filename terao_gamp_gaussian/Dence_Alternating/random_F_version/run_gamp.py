#!/usr/bin/env python
"""
Parallel runner for the random-F version of Dence_Alternating G-AMP.

This keeps the numerical update path in ``random_F_version.core`` and
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run the random-F version of Dence_Alternating G-AMP in parallel, "
...
def plot_results(
    ...
    ax.set_title(
        f"Cosine Similarity vs Alpha (Parallel Random F Version)\n"
...
def save_config(
    ...
    config = {
        ...
        "evaluation_metric": "cosine_similarity_in_observed_F_weighted_signal_space",
...
def main() -> int:
    ...
    results_dir = results_root / (
        f"{timestamp}_gamp_Dence_Alternating_random_F_parallel_"
    ...
    print("=" * 72)
    print("Parallel Dence_Alternating G-AMP - Random F Version")
    print("=" * 72)
