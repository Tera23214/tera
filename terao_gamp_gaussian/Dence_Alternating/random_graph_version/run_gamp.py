...
if __name__ == "__main__":
    print("=" * 60)
    print("Dense-mask Alternating G-AMP (random_graph_version)")
    print("=" * 60)
    ...
    results_dir_name = (
        f"{timestamp}_gamp_Dence_Alternating_random_graph_{N1}x{M}"
    ...
    config = {
        "algorithm": "gamp_Dence_Alternating_random_graph_version",
